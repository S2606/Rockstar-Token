...
it('can add the star name and star symbol properly', async() => {
    ...
    let starId = 6;
    await instance.createStar('awesome star', starId, {from: user1});
    assert.equal(await instance.name(), "Rockstar Token");
    assert.equal(await instance.symbol(), "RRT");
});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let starId1 = 8;
    await instance.createStar('awesome star 1', starId1, {from: owner});
    assert.equal(await instance.lookUptokenIdToStarInfo.call(starId1), 'awesome star 1');
});